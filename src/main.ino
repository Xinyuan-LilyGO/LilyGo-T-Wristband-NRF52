...
void IMU_Show()
{
    ...
    if (imu.dataReady())
    {
        ...
        tft.setCursor(0, 0);
        tft.print("ACC x:");
        tft.print(imu.calcAccel(imu.ax));
        tft.print(" y:");
        tft.print(imu.calcAccel(imu.ay));
        tft.print(" z:");
        tft.println(imu.calcAccel(imu.az));
        tft.print("GYR x:");
        tft.print(imu.calcGyro(imu.gx));
        tft.print(" y:");
        tft.print(imu.calcGyro(imu.gy));
        tft.print(" z:");
        tft.println(imu.calcGyro(imu.gz));
        tft.print("MAG x:");
        tft.print(imu.calcMag(imu.mx));
        tft.print(" y:");
        tft.print(imu.calcMag(imu.my));
        tft.print(" z:");
        tft.println(imu.calcMag(imu.mz));
    }
